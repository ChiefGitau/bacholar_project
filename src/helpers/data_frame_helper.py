...
def section_0_setup():
    columns_section_0 = ["image_id","generator", "number", "female", "male", "age_group_a", "age_group_b", "age_group_c", "json_response"]
...
def get_data_v2():
    columns_section = ["image_id", "generator", "number", "female", "male", "age_details"]
